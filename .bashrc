...
alias configs='cd Documents/configs'
alias omarchy='cd .local/share/omarchy'
alias ripv6='sudo sysctl net.ipv6.conf.all.disable_ipv6=1'
alias aipv6='sudo sysctl net.ipv6.conf.all.disable_ipv6=0'
